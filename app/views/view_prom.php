...
<html lang="en">
    ...
    <body background="img\nueve.jpg" style="background-size: 100%">
    <div style="position: relative; left: 1200px">
        ...
        <h1 style="text-align: center; font-size: 45px ;text-shadow: 4px 2px #271AF6;">PROMEDIO ESTUDIANTIL</h1>
        <div class="container">
    <div class="row">
        ...
        <form action="<?php echo base_url(); ?>index.php/view_inst/BUSCAR" method="post">
                <input type="submit" value="BUSCAR" class="btn btn-success" style="width:110px; height:50px;">
         </form>
    </div>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">MEJOR ALUMNO</th>
      <td><a href="#" class="btn btn-success">ACCEDER</td>
    </tr>
  </tbody>
</table>
<div class="container">
    <div class="row">
        ...
        <form action="<?php echo base_url(); ?>index.php/view_inst/GUARDAR" method="post">
                <input type="submit" value="GUARDAR" class="btn btn-success" style="width:100px; height:50px">
         </form>
        </div>
        ...
        <form action="<?php echo base_url(); ?>index.php/view_inst/DESCARGAR" method="post">
                <input type="submit" value="DESCARGAR" class="btn btn-success" style="width:150px; height:50px;">
         </form>
    </div>
</div>
